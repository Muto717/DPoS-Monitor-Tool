...
public class VotesFragment extends Fragment implements RequestListener<Votes> {
    ...
    public static VotesFragment newInstance (ServerSetting serverSetting) {
        Bundle bundle = new Bundle();
        bundle.putSerializable(ARG_SERVER_SETTING, serverSetting);

        VotesFragment homeServerSettingFragment = new VotesFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = view.findViewById(R.id.votes_refresh_layout);
    ...
    public void onResponse(final Votes votes) {
        ...
        getActivity().runOnUiThread(() -> {
            ...
            RecyclerView rvVotes = view.findViewById(R.id.rvVotes);
