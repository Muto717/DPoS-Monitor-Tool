...
public class ServerSettingViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.save_btn: {
                viewModel.updateServerSettings(getEnteredValue(R.id.serverName), getEnteredValue(R.id.fld_address), getEnteredValue(R.id.fld_public_key), getEnteredValue(R.id.ip_address, "0.0.0.0"), getStringAsInt(getEnteredValue(R.id.port)),
